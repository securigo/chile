...
<body>
	...
	<header>
	        ...
	        <nav>
	            ...
	            <div class="navButton"><a href="newsletter.php">Newsletter</a></div>
	        </nav>
	</header>
    ...
    <div id="wrapper">
        ...
        <div id="leftColumn">
            ...
            <div class="tall">What are your concerns, reservations, and apprehensions about coming to Exosphere?<span>*</span></div>
            <div class="tall">Tell us anything else about yourself that you think is relevant in evaluating your application. Share links to documents, portfolios,
            or videos you have created that will help us get to know you and your unique talents better.</div>
            <div class="tall">What can we do to make your plans to join us a reality?<span>*</span></div>
        ...
        <div id="rightColumn">
            <form action="form.php" method="post">
                ...
                <div class="tall"><textarea name="question9"></textarea></div>
                <div class="tall"><textarea name="question10" optional="yes" ></textarea></div>
                <div class="tall"><textarea name="question11"></textarea></div>
